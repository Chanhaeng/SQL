...
get_ipython().run_cell_magic('sql', '', "SELECT d.user_guid AS UserID, d.dog_guid AS DogID,\n        d.breed, d.breed_type, d.breed_group\nFROM dogs d JOIN complete_tests c\n    On d.dog_guid=c.dog_guid \nWHERE test_name='Yawn Warm-up';")
