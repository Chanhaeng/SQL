...
get_ipython().run_cell_magic('sql', '', 'SELECT membership_id FROM users\nWHERE membership_type=2;')
...
get_ipython().run_cell_magic('sql', '', "SELECT dog_guid, created_at FROM complete_tests\nWHERE created_at > '2015-08-15';")
...
get_ipython().run_cell_magic('sql', '', 'SELECT membership_id \nFROM users\nWHERE state IS NOT NULL\nLIMIT 5;')
