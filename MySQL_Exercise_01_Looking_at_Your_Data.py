...
get_ipython().run_cell_magic('sql', '', 'SELECT *\nFROM reviews LIMIT 5 OFFSET 10;')
...
get_ipython().run_cell_magic('sql', '', 'SELECT median_iti_minutes, median_iti_minutes / 60\nFROM dogs LIMIT 10;')
...
get_ipython().run_cell_magic('sql', '', 'SELECT count(distinct dog_guid) AS dog_guid, count(distinct user_guid)\nFROM dogs;')
...
get_ipython().run_cell_magic('sql', '', 'select count(distinct user_guid), count(distinct dog_guid)\nfrom complete_tests')
